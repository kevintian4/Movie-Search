...
export async function getItemDetails(endpoint, id) {
  ...
  if (endpoint === 'movie') {
    url = `https://api.themoviedb.org/3/movie/${id}?append_to_response=images%2Cvideos%2Creviews%2Csimilar&language=en-US`;
  } else if (endpoint === 'tv') {
    url = `https://api.themoviedb.org/3/tv/${id}?append_to_response=images%2Cvideos%2Creviews%2Csimilar&language=en-US`;
